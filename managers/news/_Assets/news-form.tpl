  ...
  <section class="card">
    ...
    <div id="collapsePostStatus" class="collapse show" aria-labelledby="headingPostStatus" data-parent="#accordionPostStatus">
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
            <h3 class="card-title"><label class="control-label" for="post_status">News Post Status</label></h3>
...
<div id="accordionIntro">
  <section class="card">
    <header class="card-header" id="headingIntro" data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true" aria-controls="collapseIntro">
      <h2 class="card-title">News Intro</h2>
      <div class="panel-actions">
        <a class="panel-action panel-action-toggle" href="#"></a>
      </div>
    </header>
    <div id="collapseIntro" class="collapse show" aria-labelledby="headingIntro" data-parent="#accordionIntro">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <h3 class="card-title"><label class="label-control" for="post_intro">News Intro</label></h3>
